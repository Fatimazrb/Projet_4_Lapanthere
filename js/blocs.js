      ...
      a(),
        ...
        (function () {
          ...
          if ($(".sticky-nav").hasClass("fill-bloc-top-edge")) {
            var a = $(".fill-bloc-top-edge.sticky-nav")
              .parent()
...
function a() {
  $($(".hideMe").get().reverse()).each(function (t) {
    ...
    if ((e.height() > $(window).height() && (a = e.offset().top), a < i)) {
  ...
  window.targetLightbox,
    $(document)
      .on("click", "[data-lightbox]", function (t) {
        ...
        targetLightbox.attr("data-gallery-id") &&
          ...
          targetLightbox.attr("data-caption") || (i = "");
        var n = "";
        1 == a && (n = "autoplay");
        var s = $(
        ...
        $("body").append(s),
          ...
          $("#lightbox-image").length &&
            $("#lightbox-image").swipe({
              swipeLeft: function (t, e, a, i, o) {
                $(".next-lightbox").is(":visible") &&
                  $(".next-lightbox").click();
              },
              swipeRight: function () {
                $(".prev-lightbox").is(":visible") &&
                  $(".prev-lightbox").click();
              },
              threshold: 0,
            });
    ...
    $(document).on("click", ".next-lightbox, .prev-lightbox", function (t) {
      ...
      targetLightbox.attr("data-gallery-id") &&
        ...
        (i = $('a[data-gallery-id="' + e + '"]').eq(a + 1))),
        $(this).hasClass("prev-lightbox") &&
          ((i = $('a[data-gallery-id="' + e + '"]').eq(a - 1)),
          "no-gallery-set" == e && (i = $("a[data-lightbox]").eq(a - 1)));
      ...
      (targetLightbox = i),
        ...
        "no-gallery-set" == e
          ? ($("a[data-lightbox]").index(i) !=
              $("a[data-lightbox]").length - 1 && $(".next-lightbox").show(),
            $("a[data-lightbox]").index(i) > 0 && $(".prev-lightbox").show())
          : ($('a[data-gallery-id="' + e + '"]').index(i) !=
              $('a[data-gallery-id="' + e + '"]').length - 1 &&
              $(".next-lightbox").show(),
            $('a[data-gallery-id="' + e + '"]').index(i) > 0 &&
              $(".prev-lightbox").show());
    });
}
$(document).ready(function (){
  ...
  $(window)
    .load(function () {
      t(), e(), $("#page-loading-blocs-notifaction").remove();
    })
    .resize(function () {
      t();
    }),
