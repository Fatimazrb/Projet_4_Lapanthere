/*! jQuery v2.1.0 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ var e,
  t;
(e = "undefined" != typeof window ? window : this),
  (t = function (e, t) {
          ...
          for (
            ...
            if (null != (e = arguments[a]))
              for (t in e)
                (n = s[t]),
                  s !== (r = e[t]) &&
                    (l && r && (h.isPlainObject(r) || (i = h.isArray(r)))
                      ? (i
                          ? ((i = !1), (o = n && h.isArray(n) ? n : []))
                          : (o = n && h.isPlainObject(n) ? n : {}),
                        (s[t] = h.extend(l, o, r)))
                      : void 0 !== r && (s[t] = r));
          return s;
        }),
    ...
    var x = (function (e) {
      ...
      (ne.matchesSelector = function (e, t) {
        if (
          ...
          (t = t.replace(X, "='$1']")),
          !(!n.matchesSelector || !d || (g && g.test(t)) || (h && h.test(t))))
        )
          try {
            var r = m.call(e, t);
            if (
        ...
        return (
          ...
          ie(function (o, s, a, u) {
            var l,
              ...
              v = n ? (i || (o ? e : h || r) ? [] : s) : m;
            if ((n && n(m, v, a, u), r))
              for (l = ve(v, d), r(l, [], a, u), c = l.length; c--; )
                (f = l[c]) && (v[d[c]] = !(m[d[c]] = f));
            if (o) {
              if (i || e) {
                if (i) {
        ...
        var n = t.length > 0,
          ...
          o = function (o, s, u, l, c) {
            ...
            if (((g += m), n && m !== g)) {
              ...
              if (o) {
                if (g > 0) for (; m--; ) v[m] || y[m] || (y[m] = A.call(l));
                y = ve(y);
              }
              q.apply(l, y),
                c && !o && y.length > 0 && g + t.length > 1 && ne.uniqueSort(l);
            }
            return c && ((b = T), (a = x)), v;
          };
        return n ? ie(o) : o;
        ...
        if (!o && 1 === p.length) {
          ...
          for (
            ...
            if (
              (f = r.find[c]) &&
              (o = f(
                l.matches[0].replace(ee, te),
                (K.test(u[0].type) && fe(t.parentNode)) || t
              ))
            ) {
    ...
    (h.find = x),
      ...
      (h.unique = x.uniqueSort),
      (h.text = x.getText),
      (h.isXMLDoc = x.isXML),
      (h.contains = x.contains);
      ...
      h.fn.extend({
        find: function (e) {
          ...
          if ("string" != typeof e)
            return this.pushStack(
              h(e).filter(function () {
                for (t = 0; n > t; t++) if (h.contains(i[t], this)) return !0;
              })
            );
          for (t = 0; n > t; t++) h.find(e, i[t], r);
          return (
            ((r = this.pushStack(n > 1 ? h.unique(r) : r)).selector = this
              .selector
              ? this.selector + " " + e
              : e),
            r
      ...
      h.fn.extend({
        has: function (e) {
          ...
          return this.filter(function () {
            for (var e = 0; n > e; e++) if (h.contains(this, t[e])) return !0;
          });
        },
        closest: function (e, t) {
          for (
            var n,
              ...
              o = [],
              s =
                b.test(e) || "string" != typeof e ? h(e, t || this.context) : 0;
            i > r;
            r++
          )
        ...
        function (e, t) {
          h.fn[e] = function (n, r) {
            ...
            return (
              ...
              this.length > 1 &&
                (j[e] || h.unique(i), D.test(e) && i.reverse()),
              this.pushStack(i)
            );
          };
        }
    ...
    var A,
      ...
      q = {};
    function H() {
      p.removeEventListener("DOMContentLoaded", H, !1),
    ...
    (h.Callbacks = function (e) {
      ...
      h.extend({
        ...
        ready: function (e) {
          (!0 === e ? --h.readyWait : h.isReady) ||
            ...
            (!0 !== e && --h.readyWait > 0) ||
              (A.resolveWith(p, [h]),
              h.fn.trigger && h(p).trigger("ready").off("ready")));
        },
      }),
      ...
      h.ready.promise();
    var O = (h.access = function (e, t, n, r, i, o, s) {
      var a = 0,
        u = e.length,
        l = null == n;
      if ("object" === h.type(n))
        ...
        remove: function (e, t) {
          ...
          if (void 0 === t) this.cache[o] = {};
            ...
            h.isArray(t)
              ...
              : ((i = h.camelCase(t)),
                (r = t in s ? [t, i] : (r = i) in s ? [r] : r.match(L) || [])),
              (n = r.length);
            for (; n--; ) delete s[r[n]];
          }
        },
      ...
      h.fn.extend({
        data: function (e, t) {
          ...
          if (void 0 === e) {
            if (
              this.length &&
              ((i = M.get(o)), 1 === o.nodeType && !P.get(o, "hasDataAttrs"))
            ) {
              for (n = s.length; n--; )
                0 === (r = s[n].name).indexOf("data-") &&
                  ((r = h.camelCase(r.slice(5))), $(o, r, i[r]));
            ...
            : O(
                ...
                function (t) {
                  var n,
                    r = h.camelCase(e);
                  if (o && void 0 === t) {
                    if (void 0 !== (n = M.get(o, e))) return n;
                    if (void 0 !== (n = M.get(o, r))) return n;
                    if (void 0 !== (n = $(o, r, void 0))) return n;
                  } else
                    this.each(function () {
                      var n = M.get(this, r);
                      M.set(this, r, t),
    ...
    (h.event = {
          ...
          for (
            n.handler && ((n = (o = n).handler), (i = o.selector)),
              ...
              (s = v.handle) ||
                (s = v.handle =
                  function (t) {
                    return typeof h !== z && h.event.triggered !== t.type
                      ? h.event.dispatch.apply(e, arguments)
                      : void 0;
                  }),
            ...
            if (
              ...
              s &&
                ...
                ((f.teardown && !1 !== f.teardown.call(e, g, v.handle)) ||
                  h.removeEvent(e, d, v.handle),
                delete u[d]);
            } else for (d in u) h.event.remove(e, d + t[l], n, r, !0);
          h.isEmptyObject(u) && (delete v.handle, P.remove(e, "events"));
        }
      },
      trigger: function (t, n, r, i) {
        ...
        if (
          ...
          3 !== r.nodeType &&
            8 !== r.nodeType &&
            !Y.test(m + h.event.triggered) &&
            (m.indexOf(".") >= 0 &&
              ((v = m.split(".")), (m = v.shift()), v.sort()),
            (c = m.indexOf(":") < 0 && "on" + m),
            ((t = t[h.expando]
              ? t
              : new h.Event(m, "object" == typeof t && t)).isTrigger = i
              ? 2
              : 3),
            (t.namespace = v.join(".")),
          ...
          if (!i && !d.noBubble && !h.isWindow(r)) {
            for (
              u = d.delegateType || m, Y.test(u + m) || (s = s.parentNode);
              s;
              s = s.parentNode
            )
              g.push(s), (a = s);
          ...
          for (o = 0; (s = g[o++]) && !t.isPropagationStopped(); )
            (t.type = o > 1 ? u : d.bindType || m),
              (f = (P.get(s, "events") || {})[t.type] && P.get(s, "handle")) &&
                f.apply(s, n),
              (f = c && s[c]) &&
                f.apply &&
                h.acceptData(s) &&
      ...
      dispatch: function (e) {
        ...
        if (
          ...
          for (
            a = h.event.handlers.call(this, e, l), t = 0;
            ...
            for (
              ...
              (!e.namespace_re || e.namespace_re.test(s.namespace)) &&
                ...
                void 0 !==
                  (i = (
                    (h.event.special[s.origType] || {}).handle || s.handler
                  ).apply(o.elem, u)) &&
                  !1 === (e.result = i) &&
      ...
      fix: function (e) {
        ...
        for (
          s ||
            (this.fixHooks[i] = s =
              V.test(i) ? this.mouseHooks : U.test(i) ? this.keyHooks : {}),
      ...
      f.focusinBubbles ||
        h.each({ focus: "focusin", blur: "focusout" }, function (e, t) {
          var n = function (e) {
    ...
    (ae.optgroup = ae.option),
      ...
      h.extend({
        clone: function (e, t, n) {
          ...
          if (
            ...
            for (s = de(a), r = 0, i = (o = de(e)).length; i > r; r++)
              he(o[r], s[r]);
          if (t)
            if (n)
              for (
                o = o || de(e), s = s || de(a), r = 0, i = o.length;
                i > r;
                r++
              )
                pe(o[r], s[r]);
          ...
          return (
            (s = de(a, "script")).length > 0 && fe(s, !u && de(e, "script")), a
          );
        },
        buildFragment: function (e, t, n, r) {
              ...
              if ("object" === h.type(i)) h.merge(f, i.nodeType ? [i] : i);
                ...
                for (
                  o = o || c.appendChild(t.createElement("div")),
                    ...
                    a = ae[s] || ae._default,
                    o.innerHTML = a[1] + i.replace(Z, "<$1></$2>") + a[2],
                    l = a[0];
                  l--;
          ...
          for (c.textContent = "", p = 0; (i = f[p++]); )
            if (
              (!r || -1 === h.inArray(i, r)) &&
              ((u = h.contains(i.ownerDocument, i)),
              (o = de(c.appendChild(i), "script")),
              u && fe(o),
              n)
            )
        ...
        cleanData: function (e) {
          for (
            ...
            if (h.acceptData(n) && (o = n[P.expando]) && (t = P.cache[o])) {
      ...
      h.fn.extend({
        ...
        remove: function (e, t) {
          for (
            ...
            t || 1 !== n.nodeType || h.cleanData(de(n)),
              n.parentNode &&
                (t && h.contains(n.ownerDocument, n) && fe(de(n, "script")),
                n.parentNode.removeChild(n));
          return this;
        },
        empty: function () {
          for (var e, t = 0; null != (e = this[t]); t++)
            1 === e.nodeType && (h.cleanData(de(e, !1)), (e.textContent = ""));
          return this;
        },
        clone: function (e, t) {
          return (
            ...
            function (e) {
              ...
              if (
                ...
                try {
                  for (; r > n; n++)
                    1 === (t = this[n] || {}).nodeType &&
                      (h.cleanData(de(t, !1)), (t.innerHTML = e));
                  t = 0;
                } catch (e) {}
              }
        ...
        domManip: function (e, t) {
          ...
          if (
            m ||
            (c > 1 && "string" == typeof g && !f.checkClone && re.test(g))
          )
          ...
          if (
            c &&
            ((r = (n = h.buildFragment(e, this[0].ownerDocument, !1, this))
              .firstChild),
            1 === n.childNodes.length && (n = r),
            r)
          ) {
            for (s = (o = h.map(de(n, "script"), le)).length; c > l; l++)
              (a = n),
                l !== d &&
                  ((a = h.clone(a, !0, !0)), s && h.merge(o, de(a, "script"))),
                t.call(this[l], a, l);
            if (s)
              for (
                u = o[o.length - 1].ownerDocument, h.map(o, ce), l = 0;
                s > l;
                l++
              )
                (a = o[l]),
                  ie.test(a.type || "") &&
                    !P.access(a, "globalEval") &&
                    h.contains(u, a) &&
                    (a.src
                      ? h._evalUrl && h._evalUrl(a.src)
                      : h.globalEval(a.textContent.replace(se, "")));
          }
          return this;
        },
      }),
      h.each(
        ...
        function (e, t) {
          h.fn[e] = function (e) {
            for (var n, r = [], i = h(e), s = i.length - 1, a = 0; s >= a; a++)
    ...
    function ye(e) {
      ...
      return (
        n ||
          (("none" !== (n = ve(e, t)) && n) ||
            ((t = (ge = (
              ge || h("<iframe frameborder='0' width='0' height='0'/>")
    ...
    function Te(e, t, n) {
      ...
      return (
        ...
        n &&
          ("" !== s || h.contains(e.ownerDocument, e) || (s = h.style(e, t)),
          be.test(s) &&
            xe.test(t) &&
            ((r = a.width),
            (i = a.minWidth),
    ...
    function qe(e, t, n, r, i) {
      for (
        ...
        "margin" === n && (s += h.css(e, n + I[o], !0, i)),
          r
            ? ("content" === n && (s -= h.css(e, "padding" + I[o], !0, i)),
              "margin" !== n &&
                (s -= h.css(e, "border" + I[o] + "Width", !0, i)))
            : ((s += h.css(e, "padding" + I[o], !0, i)),
              "padding" !== n &&
                (s += h.css(e, "border" + I[o] + "Width", !0, i)));
      return s;
    }
    function He(e, t, n) {
      ...
      if (0 >= i || null == i) {
        if (
          ((0 > (i = Te(e, t, o)) || null == i) && (i = e.style[t]), be.test(i))
        )
          return i;
    ...
    function Oe(e, t) {
      for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++)
        (r = e[s]).style &&
          ((o[s] = P.get(r, "olddisplay")),
          (n = r.style.display),
          t
            ? (o[s] || "none" !== n || (r.style.display = ""),
              "" === r.style.display &&
                _(r) &&
                (o[s] = P.access(r, "olddisplay", ye(r.nodeName))))
            : o[s] ||
              ((i = _(r)),
              ((n && "none" !== n) || !i) &&
                P.set(r, "olddisplay", i ? n : h.css(r, "display"))));
      for (s = 0; a > s; s++)
        (r = e[s]).style &&
    ...
    h.extend({
      ...
      style: function (e, t, n, r) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          var i,
            ...
            u = e.style;
          return (
            (t = h.cssProps[a] || (h.cssProps[a] = Ae(u, a))),
      ...
      css: function (e, t, n, r) {
        var i,
          ...
          a = h.camelCase(t);
        return (
          (t = h.cssProps[a] || (h.cssProps[a] = Ae(e.style, a))),
          (s = h.cssHooks[t] || h.cssHooks[a]) &&
            "get" in s &&
            (i = s.get(e, !0, n)),
          void 0 === i && (i = Te(e, t, r)),
          ...
          "" === n || n
            ? ((o = parseFloat(i)), !0 === n || h.isNumeric(o) ? o || 0 : i)
            : i
        );
      },
    }),
      h.each(["height", "width"], function (e, t) {
        h.cssHooks[t] = {
          get: function (e, n, r) {
            return n
              ? 0 === e.offsetWidth && Ne.test(h.css(e, "display"))
                ? h.swap(e, De, function () {
                    return He(e, t, r);
                  })
                : He(e, t, r)
              : void 0;
          ...
          set: function (e, n, r) {
            ...
            return Le(
              ...
              n,
              r
                ? qe(e, t, r, "border-box" === h.css(e, "boxSizing", !1, i), i)
                : 0
            );
          },
        };
      }),
      (h.cssHooks.marginRight = Ce(f.reliableMarginRight, function (e, t) {
        return t
      ...
      h.each({ margin: "", padding: "", border: "Width" }, function (e, t) {
        (h.cssHooks[e + t] = {
          ...
          xe.test(e) || (h.cssHooks[e + t].set = Le);
      }),
      h.fn.extend({
        css: function (e, t) {
          return O(
        ...
        toggle: function (e) {
          return "boolean" == typeof e
            ? e
              ...
              : this.hide()
            : this.each(function () {
                _(this) ? h(this).show() : h(this).hide();
              });
        },
      }),
      (h.Tween = Fe),
      ...
      Be = [
        function (e, t, n) {
          var r,
            ...
            g = P.get(e, "fxshow");
          for (r in (n.queue ||
            (null == (a = h._queueHooks(e, "fx")).unqueued &&
              ((a.unqueued = 0),
              (u = a.empty.fire),
          ...
          1 === e.nodeType &&
            ...
            "none" === (l = h.css(e, "display")) && (l = ye(e.nodeName)),
            "inline" === l &&
              "none" === h.css(e, "float") &&
          ...
          if (!h.isEmptyObject(f))
            ...
            c.done(function () {
              var t;
              for (t in (P.remove(e, "fxshow"), f)) h.style(e, t, f[t]);
            }),
            f))
              (s = ze(d ? g[r] : 0, r, c)),
                r in g ||
        ...
        "*": [
          function (e, t) {
            var n = this.createTween(e, t),
              ...
              s =
                (h.cssNumber[e] || ("px" !== o && +r)) &&
                We.exec(h.css(n.elem, e)),
              a = 1,
              u = 20;
            if (s && s[3] !== o) {
              (o = o || s[3]), (i = i || []), (s = +r || 1);
    ...
    (h.Animation = h.extend(Ue, {
      ...
      (h.fx.tick = function () {
        var e,
          t = 0,
          n = h.timers;
        for (Pe = h.now(); t < n.length; t++)
          (e = n[t])() || n[t] !== e || n.splice(t--, 1);
        n.length || h.fx.stop(), (Pe = void 0);
      }),
      ...
      (h.fx.interval = 13),
      (h.fx.start = function () {
        Me || (Me = setInterval(h.fx.tick, h.fx.interval));
      }),
      (h.fx.stop = function () {
      ...
      (function () {
        ...
        (e.type = "checkbox"),
          ...
          ((e = p.createElement("input")).value = "t"),
          (e.type = "radio"),
          (f.radioValue = "t" === e.value);
      })();
    var Ve,
      Ye = h.expr.attrHandle;
    h.fn.extend({
      attr: function (e, t) {
      ...
      h.extend({
        attr: function (e, t, n) {
          var r,
            ...
            o = e.nodeType;
          if (e && 3 !== o && 8 !== o && 2 !== o)
            return typeof e.getAttribute === z
              ? h.prop(e, t, n)
              : ((1 === o && h.isXMLDoc(e)) ||
                  ((t = t.toLowerCase()),
                  (r =
                    h.attrHooks[t] ||
                    (h.expr.match.bool.test(t) ? Ve : void 0))),
                void 0 === n
          ...
          : this.each(
              h.isFunction(e)
                ...
                : function () {
                    if ("string" === n)
                      for (
                        var t, r = 0, i = h(this), o = e.match(L) || [];
                        (t = o[r++]);
        ...
        return arguments.length
          ? ((r = h.isFunction(e)),
            this.each(function (n) {
              var i;
              1 === this.nodeType &&
                (null == (i = r ? e.call(this, n, h(this).val()) : e)
                  ? (i = "")
                  : "number" == typeof i
                  ? (i += "")
                  : h.isArray(i) &&
          ...
          select: {
            ...
            set: function (e, t) {
              for (
                ...
                ((r = i[s]).selected = h.inArray(h(r).val(), o) >= 0) &&
                  (n = !0);
    ...
    (et = at.exec(tt.toLowerCase()) || []),
      h.extend({
        ...
        ajax: function (e, t) {
          ...
          c.ifModified &&
            (h.lastModified[r] &&
              w.setRequestHeader("If-Modified-Since", h.lastModified[r]),
            h.etag[r] && w.setRequestHeader("If-None-Match", h.etag[r])),
          ...
          function T(e, t, o, a) {
            ...
            2 !== x &&
              ...
              l
                ? (c.ifModified &&
                    ((T = w.getResponseHeader("Last-Modified")) &&
                      (h.lastModified[r] = T),
                    (T = w.getResponseHeader("etag")) && (h.etag[r] = T)),
                  204 === e || "HEAD" === c.type
                    ? (C = "nocontent")
                    : 304 === e
                    ? (C = "notmodified")
              ...
              (w.status = e),
              (w.statusText = (t || C) + ""),
              l ? d.resolveWith(f, [v, C, w]) : d.rejectWith(f, [w, C, y]),
              w.statusCode(m),
              (m = void 0),
              u &&
                p.trigger(l ? "ajaxSuccess" : "ajaxError", [w, c, l ? v : y]),
              g.fireWith(f, [w, C]),
              u &&
      ...
      h.each(["get", "post"], function (e, t) {
        h[t] = function (e, n, r, i) {
          return (
            ...
            h.ajax({ url: e, type: t, dataType: i, data: n, success: r })
          );
        };
      }),
      h.each(
    ...
    e.ActiveXObject &&
      ...
      h.ajaxTransport(function (e) {
        var t;
        return f.cors || (Ct && !e.crossDomain)
          ? {
              send: function (n, r) {
                var i,
                  o = e.xhr(),
    ...
    (h.offset = {
      ...
      h.each(["top", "left"], function (e, t) {
        h.cssHooks[t] = Ce(f.pixelPosition, function (e, n) {
          return n
            ? ((n = Te(e, t)), be.test(n) ? h(e).position()[t] + "px" : n)
            : void 0;
        });
      }),
    ...
    return (
      (h.noConflict = function (t) {
        return (
          e.$ === h && (e.$ = At), t && e.jQuery === h && (e.jQuery = St), h
        );
      }),
      typeof t === z && (e.jQuery = e.$ = h),
      h
    );
  }),
