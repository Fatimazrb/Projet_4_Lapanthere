  ...
  (o = function () {
          ...
          o = function (e) {
            ...
            if (
              ("string" == typeof e.el || "string" == typeof e.div
                ? u.indexOf("#") > -1
                  ? (this.el = p(u, e.context))
                  : (this.el = l.apply(this, [u, e.context]))
                : (this.el = u),
            ...
            for (
              ...
              delete e[h[r]];
            for (
              1 != e.disableDefaultUI && (O = n(O, P)), C = n(O, e), r = 0;
              r < a.length;
              r++
            )
              delete C[a[r]];
              ...
              (this.setContextMenu = function (e) {
                ...
                for (o in e.options)
                  if (e.options.hasOwnProperty(o)) {
                    var r = e.options[o];
                    window.context_menu[s.el.id][e.control][r.name] = {
                      title: r.title,
                      action: r.action,
                    };
                  }
    ...
    return (
        ...
        return (
          google.maps.event.addListener(l, "click", function () {
            (this.details = o),
              ...
              l.infoWindow &&
                (t.hideInfoWindows(), l.infoWindow.open(t.map, l));
          }),
      ...
      (g.prototype.removeMarkers = function (e) {
        ...
        if (void 0 === e) {
          for (var o = 0; o < this.markers.length; o++)
            (r = this.markers[o]).setMap(null),
              g.fire("marker_removed", r, this);
        ...
        for (var t = 0; t < this.polylines.length; t++)
          if (this.polylines[t] === e) {
            this.polylines[t].setMap(null),
              ...
              g.fire("polyline_removed", e, this);
            break;
          }
      }),
      ...
      (g.prototype.getRoutes = function (e) {
        ...
        (r.origin = /string/.test(typeof e.origin)
          ? e.origin
          : new google.maps.LatLng(e.origin[0], e.origin[1])),
          (r.destination = /string/.test(typeof e.destination)
            ? e.destination
        ...
        new google.maps.DirectionsService().route(r, function (t, o) {
          if (o === google.maps.DirectionsStatus.OK) {
            for (var n in t.routes)
              t.routes.hasOwnProperty(n) && i.push(t.routes[n]);
            e.callback && e.callback(i, t, o);
      ...
      (g.prototype.getElevations = function (e) {
        (e = n({ locations: [], path: !1, samples: 256 }, e)).locations.length >
          0 &&
          e.locations[0].length > 0 &&
          (e.locations = i(r([e.locations], a, !1)));
        var t = e.callback;
        delete e.callback;
      ...
      (g.staticMapURL = function (e) {
        ...
        for (var c in (delete e.sensor, o.push("sensor=" + p), e))
          e.hasOwnProperty(c) && o.push(c + "=" + e[c]);
        if (r)
          for (var g, h, u = 0; (t = r[u]); u++) {
            for (var c in ((g = []),
        ...
        if (i)
          for (u = 0; u < i.length; u++) {
            ...
            for (var m = 0; m < i[u].stylers.length; m++)
              for (var f in i[u].stylers[m]) {
                var y = i[u].stylers[m][f];
      ...
      (g.prototype.createPanorama = function (e) {
        return (
          ...
          (this.panorama = g.createPanorama(e)),
      ...
      (g.on = function (e, t, o) {
        if (-1 == g.custom_events.indexOf(e))
          return (
            t instanceof g && (t = t.map),
      ...
      Array.prototype.indexOf ||
        (Array.prototype.indexOf = function (e) {
          ...
          if (
            ...
            return -1;
          for (var r = n >= 0 ? n : Math.max(o - Math.abs(n), 0); r < o; r++)
